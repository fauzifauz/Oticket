            ...
            <div class="bg-white rounded-2xl sm:rounded-3xl shadow-sm border border-gray-100 overflow-hidden text-left">
                <div class="px-5 sm:px-8 py-5 sm:py-6 border-b border-gray-100 bg-white flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    ...
                    <div class="w-full md:w-auto">
                        <form action="{{ route('admin.activity_logs.index') }}" method="GET" class="grid grid-cols-2 lg:flex lg:items-center gap-2 sm:gap-3 w-full">
                            <div class="col-span-2 lg:w-64 flex items-center gap-2 flex-nowrap">
                                ...
                                <!-- Total for Mobile -->
                                <div class="lg:hidden px-3 py-2 bg-indigo-50/50 border border-indigo-100/50 rounded-xl flex items-center gap-1.5 shrink-0 whitespace-nowrap">
                                    <span class="w-1.5 h-1.5 rounded-full bg-indigo-500 animate-pulse"></span>
                                    <span class="text-[9px] font-black text-indigo-600 uppercase tracking-widest whitespace-nowrap">
                                        Total: {{ $logs->total() }}
                                    </span>
                                </div>
                            </div>
                            ...
                            <div class="col-span-2 md:col-span-1 flex items-center justify-between md:justify-start gap-2">
                                <button type="submit" class="hidden lg:inline-flex items-center px-4 py-2 bg-gray-900 text-white rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-gray-800 transition-all active:scale-95">
                                    Filter
                                </button>
                                <div class="hidden lg:flex px-3 py-2 bg-indigo-50/50 border border-indigo-100/50 rounded-xl items-center gap-1.5 shrink-0 ml-auto lg:ml-0">
                                    <span class="w-1.5 h-1.5 rounded-full bg-indigo-500 animate-pulse"></span>
                                    <span class="text-[9px] font-black text-indigo-600 uppercase tracking-widest whitespace-nowrap">
                                        Total: {{ $logs->total() }}
                                    </span>
