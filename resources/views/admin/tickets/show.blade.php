                                ...
                                <div class="flex flex-wrap gap-3 mt-4 pt-6 border-t border-gray-50">
                                    @foreach($ticket->attachments as $attachment)
                                        ...
                                        <a href="{{ Storage::url($attachment->file_path) }}" 
                                           ...
                                           class="flex items-center gap-3 px-4 py-3 bg-white border border-gray-100 rounded-2xl group hover:border-indigo-600 hover:shadow-md transition-all duration-200 cursor-zoom-in">
                                            ...
                                            <div>
                                                <p class="text-[10px] font-bold text-gray-400 uppercase tracking-widest leading-none mb-1">{{ $label }}</p>
                        ...
                        <div class="p-3 space-y-4 relative z-10">
                            @if(!empty($similarTickets) && count($similarTickets) > 0)
                                @foreach($similarTickets as $match)
                                    <div class="group/item relative pl-3 border-l border-indigo-500/30 hover:border-emerald-500 transition-colors duration-300">
                                        <div class="flex justify-between items-start mb-1 gap-2 text-left">
                                            <a href="{{ route('admin.tickets.show', $match['id']) }}" target="_blank" class="text-[11px] font-black text-white hover:text-emerald-300 transition-colors uppercase tracking-tight line-clamp-1 leading-tight">
                                                {{ $match['subject'] }}
                                            </a>
                                        ...
                                        <a href="{{ route('admin.tickets.show', $match['id']) }}" target="_blank" class="inline-flex items-center text-[9px] font-bold text-indigo-300 hover:text-white uppercase tracking-wider transition-colors group-hover/item:translate-x-1 duration-300">
                                            Access Protocol
