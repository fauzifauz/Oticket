...
<head>
    ...
    <title>Yearly Performance Audit - {{ $startDate->year }}</title>
    <style>
...
<body>
    <div class="header-container">
        <h1 class="header-title">Annual Performance Audit</h1>
        <p class="header-subtitle">OPERATIONAL EXCELLENCE PROTOCOL • CALENDAR YEAR {{ $startDate->year }}</p>
    </div>
    ...
    <div class="content-container">
        <div class="grid-2">
            <div class="col">
                <h3 class="section-title">Institutional Distribution</h3>
                <table>
                    <thead>
                        <tr>
            ...
            <div class="col">
                <h3 class="section-title">Priority Audit</h3>
                <table>
                    <thead>
                        <tr>
                            <th>Priority</th>
        ...
        <h3 class="section-title">Support Operative Registry (Yearly)</h3>
        <table>
            <thead>
                <tr>
                    <th width="35%">Operative Agent</th>
                    <th width="15%">Resolved</th>
                    <th width="25%">Audit Score</th>
                    <th width="25%">Output Consistency</th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    <td>
                        <div style="font-weight: 800; color: #1e293b;">{{ strtoupper($user->name) }}</div>
                        <div style="font-size: 6px; color: #64748b;">AGENT-REF-{{ $user->id }} • SUPPORT CORE</div>
                    </td>
                    <td style="font-weight: 800; font-size: 10px; color: #0f172a;">{{ $user->resolved_count }}</td>
                    <td>
                        ...
                        <span style="font-size: 6px; font-weight: 800;">{{ number_format($user->avg_rating, 1) }} KPI INDEX</span>
                    </td>
                    <td>
                        ...
                        <div style="font-size: 5px; color: #94a3b8; font-weight: 800;">ANNUAL SHARE</div>
                    </td>
                </tr>
                @endforeach
            </tbody>
    ...
    <div class="header-container" style="padding: 15px 30px;">
        <h1 class="header-title" style="font-size: 14px;">Annual Ticket Ledger Annex</h1>
    </div>

    <div class="content-container">
        <h3 class="section-title">Comprehensive Ticket Inventory (Annual)</h3>
        <table>
            <thead>
                <tr>
                    <th width="8%">ID</th>
    ...
    <div class="footer">
        <p class="footer-text">OFFICIAL ANNUAL PERFORMANCE AUDIT &bull; OTICKET CORE INFRASTRUCTURE</p>
        <p class="footer-text">Organization Confidential &bull; &copy; {{ date('Y') }} OTicket System</p>
        <p class="verification-code">VERIFICATION HASH: {{ strtoupper(md5($startDate->year)) }}</p>
    </div>
</body>
</html>
