<x-guest-layout>
    ...
    <div class="mb-6 sm:mb-8 text-center text-left">
        <h2 class="text-2xl sm:text-3xl font-extrabold text-gray-900 mb-2">Set New Password</h2>
        <p class="text-sm sm:text-base text-gray-600">Secure your account with a new password</p>
    </div>
